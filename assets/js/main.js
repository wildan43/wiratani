(function ($) {
	...
	/*  Pupuk Organik
	----------------------------------------*/
	document.querySelectorAll('.info-dropdown-btn').forEach(function(btn) {
    btn.addEventListener('click', function() {
        // Ambil semua konten dropdown dan tombol
        const allContents = document.querySelectorAll('.info-dropdown-content');
        const allBtns = document.querySelectorAll('.info-dropdown-btn');
        // Toggle: jika salah satu dibuka, buka semua; jika ditutup, tutup semua
        ...
        if (isOpen) {
            ...
            allContents.forEach(c => c.style.display = 'block');
        }
    });
});
